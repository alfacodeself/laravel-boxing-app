                            ...
                            <tbody>
                                @foreach ($trainers as $trainer)
                                    <tr>
                                        ...
                                        <x-admin.table.td>{{ $trainer->trainer->nama }}</x-admin.table.td>
                                        <x-admin.table.td>{{ Str::upper($trainer->keterangan) }}</x-admin.table.td>
                                        <x-admin.table.td>
                                            <button data-bs-toggle="modal"
                                                onclick="keterangan('{{ route('admin.absent.trainer.absent', [$id, $trainer->id]) }}')"
