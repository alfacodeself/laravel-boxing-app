...
class AccountController extends Controller
{
    ...
    {
        $account = auth()->user();
        return view('app.trainer.account', compact('account'));
    }
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('trainer.account.index')->with('success', 'Akun trainer - ' . $user->trainer->nama . ' - berhasil diubah!');
        } catch (\Throwable $th) {
